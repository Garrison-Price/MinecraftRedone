...
public class TerrainTest 
{
    ...
    public TerrainTest()
    {
        lines = new float[][]   {{ 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f},
                                { 0f, 1f, 1f, 2f, 2f, 1f, 1f, 0f},
                                { 0f, 1f, 2f, 3f, 3f, 2f, 1f, 0f},
                                { 0f, 2f, 3f, 4f, 4f, 3f, 2f, 0f},
                                { 0f, 2f, 3f, 4f, 4f, 3f, 2f, 0f},
                                { 0f, 1f, 2f, 3f, 3f, 2f, 1f, 0f},
                                { 0f, 1f, 1f, 2f, 2f, 1f, 1f, 0f},
    ...
    private void drawDemLines()
    {
        for(int x = 0; x < lines.length; x++)
        {
            for(int y = 0; y < lines.length; y++)
            {
                if(x == lines.length - 1 && y == lines.length -1)
                {
                ...
                else if (x == lines.length - 1)
                {
                    glBegin(GL_TRIANGLE_STRIP);
                        glVertex3f(x, lines[x][y], y);
                        glVertex3f(x, lines[x][y+1], y+1);
                        glVertex3f(x-1, lines[x-1][y+1], y+1);
                        glVertex3f(x, lines[x][y], y);
                    glEnd();
                }
